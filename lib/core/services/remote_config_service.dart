...
class RemoteConfigService {
  ...
  static Future<void> initialize() async {
    ...
    if (!FirebaseService.isSupported) {
      AppLogger.d("RemoteConfigService: Skipped on unsupported platform");
      _initialized = true;
      return;
    }
  ...
  static bool get featureVoiceInput => instance?.getBool("feature_voice_input") ?? true;
  static bool get featureReceiptScan => instance?.getBool("feature_receipt_scan") ?? true;
  static bool get featureBankImport => instance?.getBool("feature_bank_import") ?? true;
  static bool get featureFamilySharing => instance?.getBool("feature_family_sharing") ?? true;
  static bool get featureInsights => instance?.getBool("feature_insights") ?? true;
  static bool get featureInvestments => instance?.getBool("feature_investments") ?? true;
  static bool get featureLoans => instance?.getBool("feature_loans") ?? true;

  // ============================================================
  // App Config
  // ============================================================

  static String get minAppVersion => instance?.getString("min_app_version") ?? "1.0.0";
  static bool get forceUpdateEnabled => instance?.getBool("force_update_enabled") ?? false;
  static bool get maintenanceMode => instance?.getBool("maintenance_mode") ?? false;
  ...
  static int get freeTransactionLimit => instance?.getInt("free_transaction_limit") ?? 50;
  static int get freeAccountLimit => instance?.getInt("free_account_limit") ?? 2;
  static int get freeBudgetLimit => instance?.getInt("free_budget_limit") ?? 3;

  // ============================================================
  // UI Config
  // ============================================================

  static bool get showAds => instance?.getBool("show_ads") ?? false;
  static bool get onboardingEnabled => instance?.getBool("onboarding_enabled") ?? true;
  static bool get reviewPromptEnabled => instance?.getBool("review_prompt_enabled") ?? true;

  // ============================================================
  // Backend Config
  // ============================================================

  static int get apiTimeoutSeconds => instance?.getInt("api_timeout_seconds") ?? 30;
